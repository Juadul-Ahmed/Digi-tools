      ...
      <div className="mt-10 w-11/12 mx-auto  grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {products.map((product) => (
          <div className="relative w-full max-w-sm p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <button className="w-full py-4 bg-gradient-to-r from-[#6333ff] to-[#9933ff] text-white font-bold rounded-2xl hover:opacity-90 transition-opacity active:scale-[0.98]">
              Buy Now
            </button>
          </div>
        ))}
